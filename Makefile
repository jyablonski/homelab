...
up:
	...
	@./scripts/run-step.sh "Configuring ingress access" -- bash -c 'INGRESS_HOSTS="apps.home authentik.home grafana.home api.home django.home runner.home workload-chart.home agenda.home" bash ./scripts/setup-ingress-home.sh'
